...
def draw_minimap():
    ...
    for d, (dx, dy) in directions.items():
        ...
        for _ in range(5):  # max 5 each side
            ...
            if nxt in visited_rooms:
                neighbor_color = (245, 245, 245)  # WHITE = visited
            elif nxt in explored_rooms:
                neighbor_color = ROOM_COLORS[rooms[nxt]["type"]]  # COLORED = explored
            else:
                neighbor_color = (0, 0, 0)  # BLACK = unknown
