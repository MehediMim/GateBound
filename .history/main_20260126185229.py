...
SCREEN_WIDTH  = SIDEBAR_W + ROOM_DRAW + padding
SCREEN_HEIGHT = ROOM_DRAW + padding
...
while True:
    ...
    screen.fill((0, 0, 0))   # ✅ ONLY ONCE, FIRST
    
    
    # Sidebar background
    pygame.draw.rect(screen, (15, 15, 15), (0, 0, SIDEBAR_W, SCREEN))
    pygame.draw.rect(screen, (180, 180, 180), (0, 0, SIDEBAR_W, SCREEN), 2)
