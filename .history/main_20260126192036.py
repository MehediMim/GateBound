...
card_images = {
    "jungle": pygame.image.load("assets/jungle.jpeg").convert_alpha(),
    "desert": pygame.image.load("assets/desert.jpeg").convert_alpha(),
    "ice": pygame.image.load("assets/ice.jpeg").convert_alpha(),
    "lava": pygame.image.load("assets/lava.jpeg").convert_alpha(),
    "arcane": pygame.image.load("assets/arcane.jpeg").convert_alpha(),
}
ROOM_COLORS = {
    "Jungle":   (60, 160, 90),
    "Desert":   (210, 190, 90),
